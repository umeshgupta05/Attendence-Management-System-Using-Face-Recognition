    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'C:/Users/HP/Downloads/drive-download-20241204T074236Z-001/Attendance/Manually Attendance/'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"C:\Users\HP\Downloads\drive-download-20241204T074236Z-001\Attendance\Manually Attendance\-------Check atttendance-------"')
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='grey80')
                cs = 'C:/Users/HP/Downloads/drive-download-20241204T074236Z-001/' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,"C:\Users\HP\Downloads\drive-download-20241204T074236Z-001/Attendance\-------Check atttendance-------"')
    ...
    def log_in():
        ...
        if username == 'system':
            if password == '767089amma':
                ...
                cs = 'C:/Users/HP/Downloads/drive-download-20241204T074236Z-001/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
